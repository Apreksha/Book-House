...
class YAF extends StatefulWidget {
  const YAF({Key? key}) : super(key: key);

  @override
  _YAFState createState() => _YAFState();
}

class _YAFState extends State<YAF> {
  ...
  Widget build(BuildContext context) {
    ...
    return internetCheck==false? Scaffold(
        appBar: AppBar(
          title: Text("Young Adult Fiction"),
                ...
                child: GestureDetector(
                  ...
                  onTap: (){
                    ...
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => Details(value:value,img: image[index],author:author[index],genre:"Young Adult Fiction",download: download[index],)));
                  },
                ),
              );
            },
